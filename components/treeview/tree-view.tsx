...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header>
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 w-full items-center py-2 transition-all first:[&[data-state=open]>i]:rotate-90",
        className
      )}
      {...props}
    >
      <i className="modus-icons h-4 w-4 shrink-0 transition-transform duration-200 text-accent-foreground/50 mr-1">
        chevron_right
      </i>
      {children}
    </AccordionPrimitive.Trigger>
